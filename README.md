...
Engineer #1	Data Preprocessing & EDA Engineer	Data loading, JSON normalization, data cleaning, duplicate removal, handling missing values, exploratory data analysis (EDA), visualization, text preprocessing, lemmatization, noun extraction
